...
namespace RPG_game_console.Heros
{
    public class Mage : Hero, IHero
    {
        public Mage(string name) : base(name)
        {
            ...
            ValidWeaponTypes = new() { WeaponType.Staffs, WeaponType.Wands };
        }
        ...
        public int Damage()
        {
            if (Equipments.HeroEquipment[Slot.Weapon] != null)
            {
                ...
                return weapon.WeaponDamage * (1 + LevelAttribute.Intelligence / 100);
            }
            else
                return 1;
        }
        ...
        public void Equip(Armor armorEquipment)
        {
            ...
            if (!isValid)
                throw new InvalidArmorException("Invalid armor equipped, please equip Cloth for hero ", Name);
        ...
        /// or
        /// Invalid weapon equipped, please equip Staffs, Wands for hero</exception>
        public void Equip(Weapon weaponEquipment)
        {
            ...
            if (!isValid)
            {
                throw new InvalidWeaponException("Invalid weapon equipped, please equip Staffs, Wand for hero ", Name);
        ...
        public int TotalAttributes()
        {
            ...
            foreach (Armor entry in Equipments.HeroEquipment.Values)
            {
                ...
                {
                    LevelAttribute.Strength += entry.ArmorAttribute.Strength;
                    LevelAttribute.Dexterity += entry.ArmorAttribute.Dexterity;
                    LevelAttribute.Intelligence += entry.ArmorAttribute.Intelligence;
