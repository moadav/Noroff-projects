...
namespace RPG_game_console.Heros
{
    public class Ranger : Hero, IHero
    {
        public Ranger(string name) : base(name)
        {
            ...
            ValidWeaponTypes = new() { WeaponType.Bows };
        ...
        public void Equip(Armor armorEquipment)
        {
            ...
            if (!isValid)
            {
                throw new InvalidArmorException("Invalid armor equipped, please equip Mail, Leather for hero ", Name);
            }
        ...
        /// or
        /// Invalid weapon equipped, please equip Bows for hero</exception>
        public void Equip(Weapon weaponEquipment)
        {
            ...
            if (!isValid)
                throw new InvalidWeaponException("Invalid weapon equipped, please equip Bows for hero ", Name);
